                    ...
                    items: [
                      {
                        ...
                        title: {
                          label: '自定义渲染',
                          tip: 'customRender | 插槽内的物料表达式可通过this.scope.record获取当前行数据，this.scope.index获取索引(该项用于自定义操作列)',
                        },
                        propType: {
                          type: 'oneOfType',
                          value: ['node', 'func'],
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          title: {
            label: '分页变化函数',
            tip: 'pagination.onChange | 页码或 pageSize 改变的回调',
          },
          propType: 'func',
          setter: [
            {
              ...
              props: {
                template:
                  'onPaginationChange(page,pageSize,${extParams}){\n// 页码或 pageSize 改变的回调\nreturn `共 ${total} 条`;\n}',
              },
            },
            'VariableSetter',
          ],
