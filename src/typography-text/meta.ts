import avatarImage from './__screenshots__/text.svg';
export default {
  group: 'Antd',
  ...
  props: [
    ...
    },
    {
      ...
      propType: { type: 'oneOf', value: ['secondary', 'success', 'warning', 'danger'] },
      setter: {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          condition: {
            type: 'JSFunction',
            value: 'target => !!target.getProps().getPropValue("editable")',
          },
        },
        {
          ...
          title: {
            label: '编辑提示语',
            tip: '自定义提示文本，当 editable.tooltip = false 时关闭',
          },
          propType: 'node',
          setter: 'SlotSetter',
          condition: {
